...
func (m *Repository) Amaryllis(w http.ResponseWriter, r *http.Request) {
	render.RenderTemplate(w, r, "amaryllis.page.tmpl", &models.TemplateData{})
}

// Lotus - renders the Lotus page
func (m *Repository) Lotus(w http.ResponseWriter, r *http.Request) {
	render.RenderTemplate(w, r, "lotus.page.tmpl", &models.TemplateData{})
}
...
// PostAvailability - Posts form date to the search-availability
